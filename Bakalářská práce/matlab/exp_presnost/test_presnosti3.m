...
A = [0 1; -1 0];             % Matice systému
b = [0; 0];                  % Vektor b
y0 = [0; 1];                 % Počáteční podmínka
t_final = 50;               
omega = 1;                   % Frekvence pro sin(t), cos(t)
analytical_solution = @(t) [sin(omega*t); cos(omega*t)];

MTSMTOL = 1e-4;              % Pro Taylorovu metodu
MTSMh   = 10;               % Krok pro Taylor
TOL     = 1e-7;              % Tolerance pro vestavěné ODE
