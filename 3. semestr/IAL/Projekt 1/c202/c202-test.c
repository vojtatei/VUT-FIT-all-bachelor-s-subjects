...
void (*tests[])(void) = {test_init,
                         // multiple
                         test_push_empty, test_push_multiple,
                         // pop
                         test_pop, test_pop_multiple,
                         // top
                         test_top, test_top_full,
                         // empty
                         test_empty, test_not_empty, test_not_empty_full,
                         // full
                         test_not_full_init, test_not_full, test_full,
                         // dispose
                         test_dispose,
                         // misc
                         test_many};
