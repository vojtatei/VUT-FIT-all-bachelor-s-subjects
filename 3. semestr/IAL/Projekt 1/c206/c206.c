...
void DLL_InsertLast( DLList *list, int data ) {
    ...
    {
        // Seznam byl prázdný, takže nový prvek bude i prvním prvkem
        list->firstElement = newElement;
    } else 
    {
        // Nastavíme následující prvek posledního prvku na nový prvek
...
void DLL_DeleteFirst( DLList *list ) {
	...
	{
        // Pokud byl první prvek aktivní, aktivita se ztratila
        if (list->activeElement == tmp) 
		{
            list->activeElement = NULL;
        }
        // Nastavíme předchozí prvek nového prvního prvku na NULL
...
void DLL_DeleteLast( DLList *list ) {
	...
	{
        // Pokud byl poslední prvek aktivní, aktivita se ztratila
        if (list->activeElement == tmp) 
		{
            list->activeElement = NULL;
        }
        // Nastavíme následující prvek nového posledního prvku na NULL
...
void DLL_DeleteAfter( DLList *list ) {
	...
	{
        // Seznam je neaktivní nebo aktivní prvek je poslední
        return;
    }
	...
	{
        // Pokud byl smazaný prvek následníkem aktivního prvku, nastavíme mu předchůdce
        tmp->nextElement->previousElement = list->activeElement;
    } else 
	{
        // Pokud byl smazaný prvek posledním prvkem, aktualizujeme ukazatel na poslední prvek
...
void DLL_DeleteBefore( DLList *list ) {
	...
	{
        // Seznam je neaktivní nebo aktivní prvek je první
        return;
    }
	...
	{
        // Pokud byl smazaný prvek předchůdcem aktivního prvku, nastavíme mu následníka
        tmp->previousElement->nextElement = list->activeElement;
    } 
	else 
	{
        // Pokud byl smazaný prvek prvním prvkem, aktualizujeme ukazatel na první prvek
...
void DLL_InsertAfter( DLList *list, int data ) {
	...
	{
        // Pokud nový prvek není posledním prvkem, nastavíme mu následující prvek
        newElement->nextElement->previousElement = newElement;
    } 
	else 
	{
        // Pokud nový prvek je posledním prvkem, aktualizujeme ukazatel na poslední prvek
        list->lastElement = newElement;
    }
...
void DLL_InsertBefore( DLList *list, int data ) {
	...
	{
        // Pokud nový prvek není prvním prvkem, nastavíme mu předchůdce
        newElement->previousElement->nextElement = newElement;
    } 
	else 
	{
        // Pokud nový prvek je prvním prvkem, aktualizujeme ukazatel na první prvek
        list->firstElement = newElement;
    }
