...
SCENARIO("14"){
  std::cerr << "14 - vertex attributes interpolated to fragment attributes" << std::endl;
...
SCENARIO("15"){
  std::cerr << "15 - perspective correct interpolation of vertex attributes to fragment attributes" << std::endl;
